...
{   
    vec3 objectColor;
    if(cylinder_color.x==1)
        objectColor=phase1Color+cylinder_color.y*(phase4Color-phase1Color);
    if(cylinder_color.x==2)
        objectColor=phase2Color+cylinder_color.y*(phase4Color-phase2Color);
    if(cylinder_color.x==3)
        objectColor=phase3Color+cylinder_color.y*(phase4Color-phase3Color);
